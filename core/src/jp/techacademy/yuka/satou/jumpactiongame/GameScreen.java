...
public class GameScreen extends ScreenAdapter {
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.yuka.satou.jumpactiongame");
    ...
    public void render (float delta) {
        ...
        mGame.batch.begin();
        mFont.draw(mGame.batch, "HightScore:" + mHighScore, 16, GUI_HEIGHT - 15);
    ...
    private void createStage() {
        ...
        mSound = Gdx.audio.newSound(Gdx.files.internal("loop1.mp3"));
